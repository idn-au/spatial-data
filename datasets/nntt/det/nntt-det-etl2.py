...
if __name__ == "__main__":
    ...
    features = gpd.read_file(Path(__file__).parent / "source" / "NTD_Register_Nat_shp" / "NTD_Register_Nat.shp")
    ...
    g.parse("source/det-metadata.ttl")

    g.serialize(destination="nntt-det.ttl", format="longturtle")
