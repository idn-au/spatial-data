...
if __name__ == "__main__":
    ...
    features = gpd.read_file(Path(__file__).parent / "source" / "CAPAD2020_marine" / "CAPAD2020_marine.shp")
    ...
    g.serialize(destination="source/features-mar.ttl", format="longturtle")
